...
if __name__ == "__main__":
    ...
    try:
        ...
        myvar = root.get_child(["0:Objects", "2:MiRVariables", "2:sSet_send_action_to_AMR"])
        obj = root.get_child(["0:Objects", "2:MiRVariables"])
        print("myvar is: ", myvar.get_browse_name())
        print("myobj is: ", obj)
